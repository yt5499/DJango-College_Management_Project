...
urlpatterns = [
    ...
    path('delete-teacher-from-college/<int:pk>', views.delete_teacher_from_college_view,name='delete-teacher-from-college'),
    ...
    path('delete-student-from-college/<int:pk>', views.delete_student_from_college_view,name='delete-student-from-college'),
